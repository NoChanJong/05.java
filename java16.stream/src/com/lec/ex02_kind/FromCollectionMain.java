...
/*
	...
	Java8부터 새로 추가된 java.util.stream패키지는 stream API들이 포함되어 있다. stream의 종류는
	...
	사용되지는 않는다. 하위 스트림이 직접적으로 사용되는 스트림인데 Stream은 객체의 요소를 처리한느
	스트림이고 IntStream, LongStream, DoubleStream은 각각 기본타입인 int, long, double요소를 처리하는
	스트림이다.
