...
public class CollectMain3 {
	...
	public static void main(String[] args) {
		List<Student> list = Arrays.asList(
				...
				new Student("홍길자", 0, Student.Gender.FEMALE, Student.City.BUSAN),
		...
		System.out.print("[서울] : ");
		by_city.get(Student.City.SEOUL).stream().forEach(s -> System.out.print(s.getName() + ", ")); // s = Student
		System.out.println();
		System.out.print("[부산] : ");
		...
		System.out.print("[서울] : ");
		by_city1.get(Student.City.SEOUL).stream().forEach(s -> System.out.print(s + ", ")); // s = String
