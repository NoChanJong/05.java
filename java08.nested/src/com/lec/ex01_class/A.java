...
public class A {
	...
	public static class C {
		...
		void c_method1() { 
			System.out.println("C.c_method() 호출 - " + c_field1 + ", c_field2 = " + c_field2);
		}
		static void c_method2() { System.out.println("C.c_method() 호출, c_field2 = " + c_field2);}
	}
	
	// 3. 로컬중첩클래스
	public void a_method() {
		class D { // 멤버안에 클래스 생성시 제어자 입력 못함
			String d_field1;
