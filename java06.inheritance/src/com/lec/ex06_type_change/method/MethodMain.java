...
public class MethodMain {
	...
	public static void main(String[] args) {
		...
		// 1) method1은 부모객체의 method1이 호
		parent.method1();
		
		// 2) method2는 자식객체에서 재정의 되었기때문에 자식객체의 메서드 즉, 
		// child.method2()가 호출
		parent.method2();
		System.out.println();
		
		// 3) method3는 자식객체에서 새롭게 추가된 메서드이기 때문에 부모객체로 타입변환시에 
		// 삭제(짤리기)되기 때문에 호출불가
		// parent.method3();
		...
		System.out.println(parent1 == parent2);		// true
		System.out.println(parent1.equals(parent2)); // true
		System.out.println("new Parent() = " + parent1.getClass());
		System.out.println();
		...
		// 2. parent2 -> child 강제형변화 -> 형변환불가 ClassCastException 예외발생
