...
/*
	...
	배열은 쉽게 생성하고 사용할 수 있지만 저장객체의 크기가 배열생성시에 고정되기 떄문에 불특정 다수
	...
	1. 인터페이스의 분류
	   ...
	   2) Map계열
	      ...
	      - Key와 Value을 한쌍(EntrySet)으로 저장, Key는 중복불가, Value는 중복가능
	...
	2. List Collection
	   ...
	   2) Vector
	      ...
	      환경에서 안전하다. 즉, 다른 쓰레드가 동시에 Vector에 접근할 수 없고 하나의 쓰레드 작업이 완료
	   ...
	   3) LinkedList   
	      ...
	      LinkedList에서 특정 인덱스에 위치한 객체를 제거하면 전후의 링크만 변경되고 나머지 링크는 
	      변경되지 않는다. 특정 인덱스에 객체를 삽입할 경우에도 동일하게 적용된다. 
	      
	      LinkedList를 생성하기 위해서는 저장할 객체타입을 타입파라미터<E>로 표기하고 기본생성자를 호출
	      하면된다. LinkedList는 처음 생성될 떄 어떠한 링크도 만들어지지 않기 때문에 내부는 비어 있게 
	      된다.
*/
public class ArrayListMain {
	...
	public static void main(String[] args) {
		...
		// 2) get - generic으로 String으로 제한을 걸었기 때문에 형변환 불필요
