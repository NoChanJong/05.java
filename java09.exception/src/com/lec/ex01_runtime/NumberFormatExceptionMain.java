...
/*
	NumberFormatExceptionMain?
	
	프로그램을 개발하다 보면 문자열로 되어 있는 숫자형 데이터를 숫자로 변화하는 경우가 자주 발생한다.
	문자열을 숫자로 변환할 때 해당 문자열이 숫자로 구성된 문자열이 아닐경우 
	즉, 숫자로 변환할 수 없는 문자열일 경우에 발생하는 예외이다.
