...
/*
	...
	2. 쓰레기수집(gc())
	   ...
	   요청할 수 있다. 이 기능을 하는 것이 System.gc()메서드이다. gc메서드는 호출하면 곧바로 실행되
	   는 것이 아니라 JVM이 빠른 시간대에 실행시키기 위해 노력한다. 
	...
	4. 현재시간(currentTimeMills(), nanoTime())
       ...
       System클래스의 currentTimeMills, nanoTime메서드는 컴퓨터시계로 부터 현재시간을 읽어서 밀리
       세컨드(1/1000), 나노세컨드(1/10^9)단위의 long타입의 값을 리턴한다. 이 메서드는 주로 프로그램
       의 소요시간을 측정하는데 사용된다.
 */
