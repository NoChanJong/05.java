...
/*
	...
	String.split(regex)은 정규표현식으로 분리하지만 StringTokennizer()는 문자(구분자)로
...
public class StringTokenizerMain {
	...
	public static void main(String[] args) {
		...
		StringTokenizer st = new StringTokenizer(text, "/"); // 구분자("/")를 정의하지 않으면 기본구분자값은 공란(" ")
		...
		System.out.println("현재 남아 있는 token의 갯수 = " + st.countTokens()); // 0
		System.out.println("현재 token이 남아 있는가? " + st.hasMoreTokens()); // false
	}
