...
/*
	...
	뒤에 다이아몬드부호 "<>"를 붙이고 사이에 타입파라미터가 위치한다. 타입파라미터는 변수명과 동일한 규칙에 따
	라 선언이 가능하지만 일반적으로 대문자 알파벳 한 글자로 선언한다.
*/
...
//		로봇.setKind(new TV());
		...
		// 참조타입이 아닌경우
		// Product<int, Student> prod8 = new Product<>(); 에러
