...
public class BoxMain {
	...
	public static void main(String[] args) {
		...
		// 과일상자.setObject(new String("홍길동"));  에러
		// 과일상자.setObject(Integer.valueOf(1));    에러
		// 과일상자.setObject(Double.valueOf(1.0));   에러
		// 과일상자.setObject('A'); 				  에러
		// 과일상자.setObject(new int[] {1,2,3,4,5}); 에러
