...
public class EmployeeMain {
	...
	public static void main(String[] args) {
		...
		emp.set질병(true);
		System.out.println("질병유무 = " + emp.is질병());
		System.out.println();

		Employee emp1 = new Employee(1000, "홍길동", new Date(), 10000, 10, true, "991225-1234567");
		Employee emp2 = new Employee(1001, "홍길순", new Date(), 20000, 20, true, "991225-2234567");
		Employee emp3 = new Employee(1002, "홍길상", new Date(), 25000, 30, true, "901225-2234567");
		...
		Employee[] employees = {emp1, emp2, emp3, new Employee(),
				 new Employee(1100, "손흥민", new Date(), 10000, 10, true, "999546-1234567")};
