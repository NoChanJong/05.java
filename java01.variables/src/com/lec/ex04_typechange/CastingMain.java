...
public class CastingMain {
	...
	public static void main(String[] args) {
		...
		i1 = (int) l1;	// 강제형변환
		System.out.println(i1 + "의 유니코드 값 = " + l1);
		System.out.println();
		
		double d1 = 3.141592; // 형변환발생되지 않는다.
		System.out.println(d1 + "의 유니코드 값 = " + d1);
		
		// 2. 강제형변환시에 값이 짤리는 경우
		i1 = (int) d1; // 강제형변환
		System.out.println(i1 + "의 유니코드 값 = " + d1);
		
		byte b1 = (byte) 128;
		System.out.println(b1 + "의 유니코드 값 = " + b1);
		...
		System.out.println(d2 + "의 유니코드 값 = " + d2);
