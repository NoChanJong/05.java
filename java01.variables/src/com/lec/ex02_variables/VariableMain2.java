...
public class VariableMain2 {
	...
	public static void main(String[] args) {
		...
		// 2. 변수의 동시선언
		int a, b, c;
		//System.out.println("a = " + a); // error : 초기화 에러
		...
		// b1 = -129; // -128을 벗어난 에러
		// b2 = 128; // byte타입이 표현할 수 있는 범위를 벗어난 에러
		b1 = (byte) -12312412; // 정수의 기본타입은 int, int를 byte로변환
		b2 = (byte) 12312412; // (byte) : int타입인 12312412을 byte로 강제변환
		System.out.println("b1= " + b1 + ", b2= " + b2);
		System.out.println();
		...
		char c2 = '가';
		// A는 내부적으로 65, 가 는 44032의 정수(유니코드)값으로 저장된다.
