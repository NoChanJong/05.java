...
/*
 	1. 변수란?
 	   ...
 	   프로그램은 작업을 처리하는 과정에서 필요에 따라 데이터를 메모리에 저장한다. 이떄 변수를 
 	   ...
 	   만 저장할 수 있다. 즉, 변수란 하나 또는 복수개의 값을 저장할 수 있는 메모리공간을 의미한다.
 	...
 	3. 변수의 사용
 	   ...
 	   값을 변경할 수 없는 , 상수는 "한 번값을 저장하면 변경할 수 없는 변수"로 정의하기 때문에
...
public class VariableMain1 {
	...
	public static void main(String[] args) {
		...
		int val3;
		// int val4 = val3 + 50; // 에러 : 초기화되지 않은 변수는 사용불가		
	}
