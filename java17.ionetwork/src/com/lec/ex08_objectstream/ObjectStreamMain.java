...
/*
	...
	객체를 출력할 때 객체의 데이터(필드값)를 연속적인 바이트데이터로 출력해야 하는데 이것을 직렬화
	(serialization)라고 한다. 입력스트림으로 부터 연속적인 바이트 데이터를 객체로 변환하는 것을 
	역직렬화(deserialization)이라고 한다. 자바는 객체를 입출력할 수 있도록 ObjectOutputStream(직렬화)
	ObjectInputStream(역질렬화)를 제공한다.
...
class Student implements Serializable{
	...
	private static final long serialVersionUID = 7960489995775915593L;
